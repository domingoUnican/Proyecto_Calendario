...
connection = pymysql.connect(host='localhost',user='Domingo',password='Domingo',db='calendario',charset='utf8mb4',cursorclass=pymysql.cursors.DictCursor, autocommit=True)
